        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Buró</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId" value="{{ $selectedCustomer->street }}">
                                        {{--  <small id="helpId" class="text-muted">Help text</small>  --}}
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">N°:</label>
                                        <input readonly type="text" name="" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId" value="{{ $selectedCustomer->in }}">
                                        {{--  <small id="helpId" class="text-muted">Help text</small>  --}}
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId" value="{{ $selectedCustomer->suburb }}">
                                        {{--  <small id="helpId" class="text-muted">Help text</small>  --}}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId" value="{{ $selectedCustomer->city }}">
                                        {{--  <small id="helpId" class="text-muted">Help text</small>  --}}
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" name="" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId" value="{{ $selectedCustomer->state }}">
                                        {{--  <small id="helpId" class="text-muted">Help text</small>  --}}
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="">CP:</label>
                                        <input readonly type="text" name="" id="" class="form-control" placeholder=""
                                            aria-describedby="helpId" value="{{ $selectedCustomer->cp }}">
                                        {{--  <small id="helpId" class="text-muted">Help text</small>  --}}
                                    </div>
                                </div>
                            </div>
