                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Configurar
                                        perfil de usuario</a>
                                </li>
                            </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class=" active tab-pane" id="settings">
                                    ...
                                    <form class="form-horizontal" action="{{ route('updateUser',$user->id) }}"
                                        method="POST">
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="user_name" class="form-control" id="user_name"
                                                    placeholder="Nombre de usuario" value="{{ $user->user_name }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-2 col-form-label">Nombre: </label>
                                            <div class="col-sm-10">
                                                <input type="text" name="full_name" class="form-control" id="inputEmail"
                                                    placeholder="Nombre" value="{{ $user->full_name }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
