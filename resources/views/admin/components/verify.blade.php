...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Verificar buro de crédito</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/home">Home</a></li>
                    <li class="breadcrumb-item active">Buro</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    @if ($status=='E')
                                    <a href="" title="DESACTIVAR" class="btn btn-success">ACTIVA</a>
                                    @else
                                    <a href="" title="ACTIVAR" class="btn btn-warning">DESACTIVADA</a>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
